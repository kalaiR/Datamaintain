...
class AbsentList_RestAPI(fxapi.RestView):
    ...
    def action_list(cls, request, limit=None, pk=None, action='list'):        
        ...
        student_admission=Student_Admission.objects.all()
        for student_admissions in student_admission:
            print regno
            print dob
            print student_admissions.reg_no
            print student_admissions.dob
            if student_admissions.reg_no == regno and student_admissions.dob == dob:
                result['data'] = "valid User"
                break
            elif student_admissions.reg_no == regno and student_admissions.dob != dob:
                result['data'] = "Invalid Date of Birth"
                break
            elif student_admissions.reg_no != regno and student_admissions.dob == dob:
                result['data'] = "Invalid Register Number"
                break
            else:
